export default function Header() {
  return (
    <nav id="navbar" className="hide-menu sm:w-11/12 sm:py-8 px-8 sm:flex sm:flex-col sm:items-center sm:gap-8 sm:absolute sm:top-24 sm:left-1/2 sm:z-10 sm:-translate-x-1/2 sm:-rotate-x-90 sm:bg-primaryDarkViolet sm:rounded-md sm:transition-transform">
